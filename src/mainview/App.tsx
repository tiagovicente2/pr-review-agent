				...
				<Stack gap="5" minW="0">
					...
					<Card.Root>
						<Card.Header>
							...
							<Card.Description>
								This is still local-only. OpenAI review generation and publishing are the next
								services to connect.
							</Card.Description>
						</Card.Header>
						<Card.Body>
				...
				<Stack gap="5">
					<Card.Root>
						<Card.Header>
							...
							<Card.Description>No fake AI findings are shown.</Card.Description>
						</Card.Header>
						<Card.Body>
							<StatusCard
								body="Next step: connect the OpenAI review generation service and store the resulting draft in SQLite."
